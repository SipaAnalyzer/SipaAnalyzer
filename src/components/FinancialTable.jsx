      ...
      <div className="overflow-x-auto">
        <table className="w-full text-sm">
          ...
          <tbody className="divide-y divide-border/50">
            ...
            <Row label="Revenu distribué sur fonds propres" value={formatPercent(analysis.revenu_distribue_fonds_propres)} muted footnote="Rendement estimatif basé sur un scénario projeté sur 5 ans" />
          </tbody>
        </table>
      </div>
    </div>
